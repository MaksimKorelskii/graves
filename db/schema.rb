...
ActiveRecord::Schema[7.0].define(version: 2023_09_17_110946) do
  ...
  create_table "graves", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_graves_on_user_id"
  end
  ...
  add_foreign_key "cemeteries", "users"
  add_foreign_key "graves", "cemeteries"
  add_foreign_key "graves", "users"
end
